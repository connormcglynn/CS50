...
int main(int argc, char *argv[])
{
    ...
    // variable for the n multiplier using the argv input
    int n = atoi(argv[1]);
    ...
    {
        // iterating over each line vertically
        for (int v = 0; v < n; v++)
        {
            ...
            for (int j = 0; j < bi.biWidth; j++)
            {
                ...
                // iterating over each pixel horizontally
                for (int h = 0; h < n; h++)
                {
